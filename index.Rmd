...
1. The draft follows a standard snake format and consists of 15 rounds.
...
2. Every owner must possess a full starting lineup by the conclusion of the draft. At a minimum, each owner must either draft and/or own through Keeper selection 1 QB, 2 RB’s, 2 WR’s, 1 TE, 1 DEF, 1 K, and 1 additional RB, WR, or TE by the conclusion of the draft.
...
2. Beginning in Week 1 of the fantasy football season, any owner may place a claim on any player on the waiver wire.

3. Acquisition requests by owners for players on waivers will processed based on their respective waiver wire priorities each week.
    a. If a player on waivers has claims from more than one team owner, the owner with the higher priority that week will acquire the player.
    b. At the end of the initial waiver period each week, once a team owner’s waiver claim has been processed their priority is moved to the end of the order and the next priority claim is processed.
...
4. Once a trade proposal has been accepted, there will be an immediate 24 hour review period where the remaining owners in the league may vote by simple majority to veto the trade.
    a. Because neither owner involved in the trade will be allowed to vote, the standard vote count to issue a veto will be 6 out of 10 in favor of the veto.
    b. If the trade has not been vetoed in the 24 hours provided for review, the trade will stand. This is subject only to intervention by the Commissioner should he decide further action is required. This action in turn will be subject to [1.1.1.3](#league-action-and-veto-power).

5. In the event that a trade proposal is accepted and an immediate approval is need to bypass the 24 hour review period, one or both team owners may petition the remaining owners to vote to approve the trade.
    a. The number of votes needed to approve a trade in this manner would be 5 out of 10 in favor of the trade. In the event of a vacated team, the vote needed would remain 5 out of 9, 4 out of 8, 4 out of 7, and so on.

6. Trades between Keepers and draft picks are discussed in [4.2.2](#trading-of-keepers-for-draft-picks).
...
2. The draft value of that player is determined by several factors:
    ...
    + If the proposed Keeper was acquired through free agency and satisfies the Active Player Rule and does not conflict with the Revalued Player Rule, the draft value of that player will be a 13th Round pick.
...
2. Any player chosen from free agency following the draft will constitute a 13th Round draft value if kept for the next fantasy season as outlined in [7.2.1.2](#draft-value-for-keepers).
...
4. The Revalued Player Rule states that any player drafted in rounds 2 through 15 who becomes a free agent during the fantasy football season will have their draft value reduced to the base level of 13th Round as outlined in [7.2.1.2](#draft-value-for-keepers), so long as that player remains a free agent for more than 2 weeks.
...
1. Overall rankings will be determined in the following order: the win/loss/tie records of each team; each team's head-to-head record; total points scored; and total points against.
