...
4. In addition to any proposed amendments, all decisions made by the Commissioner during
...
5. For the duration of the rules summit, the Commissioner will be considered an equal member of the league and will not hold special voting or vetoing privileges.

6. All Constitutional changes will go in to effect the day of the draft, prior to the first pick. Any and all changes will not be considered retroactive.
...
7. Each year a list of proposed amendments may be introduced. The purpose of a proposed amendment is to allow time for owners to consider potential constitutional changes before a final vote is cast.
    a. Amendments may be proposed by a simple motion and require no immediate vote.
    b. Proposed amendments will be collected and displayed in a location that facilitates easy access for all owners.
    c. Proposed amendments remain designated as "proposed" until the following league year when they must be submitted for a vote. After this vote they will either be ratified into the constitution or voted down and removed from the list.
...
1. The league dues are set at $75 per team.
...
6. Regardless of the transaction, no player will be allowed to own more than 4 Keepers prior to the start of any fantasy football draft.
...
1. After the conclusion of every fantasy football season each owner will choose at a minimum 2 and a maximum of 4 players from his or her team to keep for the following fantasy football season.
    a. Trading one or more of a team's Keepers during the offseason to another team owner for draft picks in the following league draft is permitted, however a team must at all times maintain ownership of at the least 2 Keepers until the conclusion of that draft.
    b. A team will never be allowed to roster more than 4 Keepers prior to that year's league draft.
    c. A team will be allowed to remove a player from their keeper list after the keeper deadline and prior to the draft, however a team must at all times maintain ownership of at least 2 keeper until the conclusion of that draft.
...
3. If an owner does not submit a list of a minimum of 2 and a maximum of 4 Keepers to the Commissioner by the Keeper Deadline, the Commissioner will penalize that team owner accordingly.
...
1. The winner of the fantasy football season will receive $750.

2. The second place team will receive $150.

3. During the draft following each league year, the last place team will be given a trophy to reward their lackluster efforts, poor team management skills, and unbecoming character.
    a. Acquisition of the trophy will be at the discretion of the Commissioner and the members of the league, and will not be addressed in the Constitution.
